...
The shared contract SHALL declare the shape of a provider one time, and the two applications SHALL both derive from it.
...
## The kind of a provider carries one set of values
...
## The name of a provider is unique
...
## A change with an empty key keeps the stored key
...
## A provider that services use cannot be removed
...
## Only an administrator writes a provider
...
## The credentials come from the record of the provider
...
## The operations of the provider client
...
## The classification of a failure of the provider
...
## The measure of the calls to the provider
...
## An empty key keeps the stored key
...
## The tab "Provider" configures the source
...
## The permissions that a provider needs
...
## The two paths of the registration
...
## The manifest that the system writes
...
## The removal of the abandoned registrations
...
## Only an administrator registers an App
...
## The returns of GitHub reach the frontend
...
## The screens of the registration report a failure
