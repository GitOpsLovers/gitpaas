...
- **The skill of the reference**, on demand, one at a time: `nestjs-best-practices`, `turborepo`, `vitest`, `tailwind-4-docs`, `typescript-advanced-types` and, for the markup of the frontend, `tailadmin-ui-patterns`. A skill of the job wins over a skill of the reference when the two disagree.
