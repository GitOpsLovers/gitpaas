...
- **Production**: the schema stays in plain SQL files in `iac/production/migrations/`. See [infrastructure architecture](../infrastructure/key-flows.md#schema-bootstrap).
