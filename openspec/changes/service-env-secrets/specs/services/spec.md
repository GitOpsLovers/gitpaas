...
The system SHALL show seven tabs, in this order: `general`, `provider`, `variables`, `deployments`,
...
### Requirement: The tab "Variables" manages the configuration

The tab `variables` SHALL list the variables of the service, and it SHALL give the actions that set, change
and remove one.
