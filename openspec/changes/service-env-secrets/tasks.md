## 1. Phase 1 — The helper of the encryption
...
## 4. Phase 4 — The tab of the variables
...
Agent: the orchestrator, with `/opsx:sync`
Paths: openspec/changes/service-env-secrets/specs/
