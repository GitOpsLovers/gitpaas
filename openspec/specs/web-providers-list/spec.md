# web-providers-list Specification

## Purpose

This capability gives the screen that lists the providers, at the route `/providers`. An operator registers
a GitHub App here, and the services of the installation select it.
