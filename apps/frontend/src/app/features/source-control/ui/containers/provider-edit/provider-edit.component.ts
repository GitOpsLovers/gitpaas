...
import { describeProviderFailureUseCase } from '@features/source-control/application/describe-provider-failure.use-case';
import { UpdateProviderDto } from '@features/source-control/domain/dtos/update-provider.dto';
import { SourceControlApiRepository } from '@features/source-control/infrastructure/api/source-control-api.repository';
import {
    ProviderFormComponent,
    ProviderFormValue,
} from '@features/source-control/ui/components/provider-form/provider-form.component';
...
export class ProviderEditComponent {
    private readonly repository = inject(SourceControlApiRepository);
