import type { ServiceVariableRow, UpdateServiceVariableDto } from '@gitpaas/contracts';
 ...
 *
 * @param variable The row of the list the user edits
 * @param draft The values the form holds
 *
 * @returns The body of the change
 */
export function buildServiceVariableUpdateUseCase(variable: ServiceVariableRow, draft: ServiceVariableDraft): UpdateServiceVariableDto {
