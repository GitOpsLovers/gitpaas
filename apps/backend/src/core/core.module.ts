...
@Module({
    ...
    providers: [DockerContainerRuntimeAdapter, NestLoggerAdapter, DiagnosticLoggerService],
    exports: [DockerContainerRuntimeAdapter, NestLoggerAdapter, DiagnosticLoggerService],
})
