...
/**
 * Use case for creating a new deployment record
 *
 ...
 */
export function createDeploymentUseCase(repository: DeploymentsRepository, createDto: CreateDeploymentDto): Promise<Deployment> {
