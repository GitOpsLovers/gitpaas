 ...
 */
const internals = (sut: DockerodeDockerExecutor): ExecutorInternals => sut as unknown as ExecutorInternals;
 ...
 */
const executorWithDaemon = (fakeDaemon: unknown): DockerodeDockerExecutor => {
    ...
    return new DockerodeDockerExecutor(mockDockerClient, mockDiagnostics);
};
