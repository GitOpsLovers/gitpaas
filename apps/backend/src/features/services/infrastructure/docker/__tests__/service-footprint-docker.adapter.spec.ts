...
import { ServiceFootprintDockerAdapter } from '../service-footprint-docker.adapter';
...
describe('ServiceFootprintDockerAdapter', () => {
    ...
    let sut: ServiceFootprintDockerAdapter;
    ...
    beforeEach(() => {
        ...
        sut = new ServiceFootprintDockerAdapter(
    ...
    it('logs a summary of the removed resources', async () => {
        ...
        expect(mockDiagnostics.log).toHaveBeenCalledWith(
            ...
            ServiceFootprintDockerAdapter.name,
        );
    });
});
