...
5. **Compare the code against the business, and report every deviation.** Read the pages under `docs/business/`. `.claude/skills/project-documentation/SKILL.md` gives the shape of a page. For every capability in scope, check three things:
