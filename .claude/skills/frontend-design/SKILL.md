...
- **The design system of this project.** The templates of `apps/frontend/src/app` and the file `styles.css` hold the truth. This skill routes to them, and it holds no markup.
- **The practice of Tailwind v4.** Read it for a decision of the engine that the project does not already answer.
