...
- **Delegate the work; do not do it inline.** Anything that reads or changes the codebase goes to a subagent. The one exception is `TODO.md`, which you always write yourself.
