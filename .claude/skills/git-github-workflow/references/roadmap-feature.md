...
3. **Step 4 — read `TODO.md` for the body of the commit.** Read it; never edit it. The body of the commit names the feature and the phase, because the Pull Request carries no body. That text stays in the commit, and it never reaches the Pull Request.
